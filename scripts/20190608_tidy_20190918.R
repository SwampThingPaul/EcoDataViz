## 
## "Tidy Tuesday" (06/18/2019) updated (09/18/2019)
##
...
# Data --------------------------------------------------------------------
dat=read.csv(paste0(data.path,"20190618/20190918_queryResults.csv"))
...
#tiff(filename=paste0(plot.path,"tiff/iowaDNR_mycrosystin_updated20190918.tiff"),width=7,height=4,units="in",res=200,type="windows",compression=c("lzw"),bg="white")
#png(filename=paste0(plot.path,"png/iowaDNR_mycrosystin_updated20190918.png"),width=7,height=4,units="in",res=200,type="windows",bg="white")
